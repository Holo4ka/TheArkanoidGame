...
namespace ArkanoidGame
{
    ...
    public class GameEngine
    {
        ...
        /// По умолчанию статистика не показывается
        /// </summary>
        ...
        public GameEngine(System.Windows.Forms.Timer gameTimer, int width, int height)
        {
            timer = gameTimer;
        ...
        public void CheckForGameLevelIncrease()
        {
            ...
            for (int level = 1; level <= TOTAL_GAME_LEVELS_TO_WIN; level++)
            {
                if (currentGameLevel == level)
                {
                    ...
                    // уменьшаем ширину движущейся платформы игрока на 10 пикселей
